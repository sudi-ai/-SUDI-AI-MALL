...
/**
 * Read-only adapter between SUDI AI and CRMEB product catalogue.
 */
class SudiAiProductSearchService
{
    private StoreProductServices $products;
    ...
    public function search(string $keyword, int $page = 1, int $limit = 12): array
    {
        ...
        // CRMEB owns product visibility, stock and price. AI only consumes the catalogue.
        $where = [
            'store_name' => $keyword,
            'is_show' => 1,
            'is_del' => 0,

...
Route::group('sudi/ai',function(){
 ...
 Route::post('customer','v2.sudi.AiController/customer')->option(['real_name'=>'苏迪AI客服','mark'=>'sudi_ai','mark_name'=>'苏迪AI']);
 Route::post('manager','v2.sudi.AiController/manager')->option(['real_name'=>'苏迪AI店长诊断','mark'=>'sudi_ai','mark_name'=>'苏迪AI']);
